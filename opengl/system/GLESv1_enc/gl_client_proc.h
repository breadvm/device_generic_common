...
typedef GLsync (gl_APIENTRY *glFenceSync_client_proc_t) (void * ctx, GLenum, GLbitfield);
typedef void (gl_APIENTRY *glDeleteSync_client_proc_t) (void * ctx, GLsync);
typedef void (gl_APIENTRY *glWaitSync_client_proc_t) (void * ctx, GLsync, GLbitfield, GLuint64);
